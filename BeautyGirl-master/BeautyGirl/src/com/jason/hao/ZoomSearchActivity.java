 ...
 */
public class ZoomSearchActivity extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photoSearchObjects = (List<PhotoSearchObject>) arrayList.get(0);
    ...
    private void initPopWindow() {
        popupwindow = new SettingPopupwindow(ZoomSearchActivity.this, DensityUtils.dip2px(ZoomSearchActivity.this, 200), DensityUtils.dip2px(ZoomSearchActivity.this, 201));
        ...
        popupwindow.setOnPopSettingClickListener(new SettingPopupwindow.OnPopSettingClickListener() {
            ...
            public void onFavroiteClick() {
                ...
                try {
                    ...
                    favroiteBean.colum = "搜索";
                    favroiteBean.tag = photoSearchObjects.get(pagerposition).getQueryExt();
                    favroiteBean.tagpingyin = CharacterParser.getInstance().getSelling(photoSearchObjects.get(pagerposition).getQueryExt());
                    favroiteBean.image_url = photoSearchObjects.get(pagerposition).getObjURL();
                    favroiteBean.description = photoSearchObjects.get(pagerposition).getFromPageTitleEnc();
                    favroiteBean.share_url = photoSearchObjects.get(pagerposition).getObjURL();
                    favroiteBeanService.save(favroiteBean);
                    ToastShow.displayToast(ZoomSearchActivity.this, getString(R.string.success_favroite));
                } catch (Exception e) {
                    ToastShow.displayToast(ZoomSearchActivity.this, getString(R.string.failure_favroite));
                    e.printStackTrace();
                }
            }
            ...
            public void onShareClick() {
                ...
                mController.getConfig().removePlatform(SHARE_MEDIA.TENCENT, SHARE_MEDIA.RENREN,
                        SHARE_MEDIA.DOUBAN);
                //默认分享方式
                mController.openShare(ZoomSearchActivity.this, false);
            }
            ...
            public void onWrapperClick() {
                if (popupwindow.isShowing())
                    popupwindow.dismiss();
                //设置壁纸
                setWallPaper(imageLoader.loadImageSync(photoSearchObjects.get(pagerposition).getObjURL()));
            }
        });
    }
    ...
    protected void initView() {
        ...
        txt_title.setText(photoSearchObjects.get(pagerposition).getFromPageTitleEnc()
                + "(" + (pagerposition + 1) + "/" + photoSearchObjects.size() + ")");
        zoom_viewpager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int arg0) {
                ...
                txt_title.setText(photoSearchObjects.get(pagerposition).getFromPageTitleEnc()
                        + "(" + currentposition + "/" + photoSearchObjects.size() + ")");
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                ZoomSearchActivity.this.finish();
            }
        });
...
//------------------------------------------微信朋友圈分享--------------------------------------------------------------
    ...
    private Runnable saveFileRunnable = new Runnable() {
        ...
        public void run() {
            try {
                //保存图片到指定路径
                ImageTools.savePhotoToSDCard(ZoomSearchActivity.this, imageLoader.loadImageSync(photoSearchObjects.get(pagerposition).getObjURL()),
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                loading.End();
                ToastShow.displayToast(ZoomSearchActivity.this, message);
            }
        }
    ...
    class ImagePagerAdapter extends PagerAdapter {
        ...
        public int getCount() {
            // TODO Auto-generated method stub
            return photoSearchObjects.size();
        }
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            imageLoader.displayImage(photoSearchObjects.get(position).getObjURL(), imageView, UniversalImageLoadTool.getImageOption(R.drawable.btn_upload_image),
